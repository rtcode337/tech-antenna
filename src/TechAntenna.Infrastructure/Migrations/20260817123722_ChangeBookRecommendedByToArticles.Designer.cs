...
namespace TechAntenna.Infrastructure.Migrations
{
    ...
    [Migration("20260817123722_ChangeBookRecommendedByToArticles")]
    partial class ChangeBookRecommendedByToArticles
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TechAntenna.Core.Models.Digest", b =>
                {
                    ...
                    b.HasIndex("Scope", "GeneratedAt");

                    b.ToTable("Digests");
                });

            modelBuilder.Entity("TechAntenna.Core.Models.NewRelease", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
